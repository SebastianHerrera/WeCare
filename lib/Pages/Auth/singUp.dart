...
class _SingUpPageState extends State<SingUpPage> {
          ...
          child: Column(
            ...
            children: <Widget>[
              ...
              isError ? Container(
                child: Center(
                  child: Text(
                    "${this.error}",style: TextStyle(color: Colors.redAccent),)),
              ):SizedBox(height: 0),
              Form(
                key: _formKey,
                child: Column(
  ...
  void singUp() async {
    ...
    if (formState.validate()) {
      ...
      try {
        dynamic currentUser = await FirebaseAuth.instance.createUserWithEmailAndPassword(email: _email, password: _password);
        ...
        return AlertDialog(
          ...
          actions: <Widget>[
            RaisedButton(
              ...
              onPressed: (){ Navigator.of(context).pop(); Navigator.pushReplacement(context, MaterialPageRoute( builder: (context) => LoginPage(), fullscreenDialog: true)); },
            )
          ],
        );
      }
